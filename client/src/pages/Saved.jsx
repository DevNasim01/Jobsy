...
const Saved = () => {
  ...
  return (
    <main className="h-dvh bg-slate-50 w-full px-24 overflow-hidden">
      <div className="text-9xl h-48 flex items-center leading-none gap-x-3 px-10 border-b-2 border-black">
        <i className="fa-solid fa-mug-hot"></i>
        <div>
          <h1 className="text-4xl font-semibold">Saved items</h1>
      ...
      {loading ? (
        <div className="w-full flex items-center flex-col z-10 gap-2 mt-28">
        ...
        <div className="w-full h-[calc(100vh-12rem)] p-10 gap-8 flex-wrap justify-center overflow-auto scrollbar-none">
